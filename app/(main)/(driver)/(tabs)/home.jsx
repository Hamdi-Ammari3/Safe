...
import { StyleSheet,Text,View,ActivityIndicator,Image,TouchableOpacity,Modal,ScrollView,Dimensions} from 'react-native'
...
const home = () => {
  ...
  //Redirect to create new intercity trip
                ...
                {driverData[0] ? (
                  <>
                    ...
                    <View style={styles.driver_manageLines_buttons}>
                      ...
                      {
                        driverData?.length > 0 && 
                        driverData[0]?.service_type === 'رحلات يومية بين المدن' && (
                          <TouchableOpacity style={styles.add_lines_button} onPress={redirectToCreateNewTrip}>
                            <Text style={styles.add_lines_button_text}>اضف رحلة جديد</Text>
                          </TouchableOpacity>
                        )
                      }
                    </View>
