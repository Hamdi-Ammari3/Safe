...
export default function SignUpScreen() {
  ...
  // Accept terms of use
  const handleAccept = () => {
    setPrivacyAccepted(privacyAccepted => !privacyAccepted)
  ...
  const onSignUpPress = async () => {
    ...
    if(!expoPushToken) {
      createAlert('يرجى تفعيل خدمة الاشعارات لتصلك اخبار الرحلات')
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      {!verifying ? (
        <>
          ...
          <TouchableOpacity 
            style={styles.privacy_terms_approve_btn} 
            //onPress={openPrivacyTermsModal}
            ...
            <View style={styles.privacy_modal_box}>
              ...
              <View style={styles.privacy_policy_box}>
                ...
                <View style={styles.privacy_policy_contact_box}>
                  <Text style={styles.privacy_policy_contact}>Email: support@safe.com</Text>
